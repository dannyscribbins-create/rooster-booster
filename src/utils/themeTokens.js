...
// CONSTANTS and the DERIVATION BEHAVIOUR across a brand x mode table, because
// either can drift alone: identical constants with a different nudge loop still
