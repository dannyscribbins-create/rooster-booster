export const SHOUT_BUCKETS = {
  rank1:    ["Catch me if you can!", "The view from the top is nice 👀", "Just warming up.", "Is anyone else even trying? 😏"],
  rank2_3:  ["Coming for that top spot!", "So close I can taste it.", "Watch your back, #1.", "The podium is just the start."],
  rank4_7:  ["I'm on my way to the top!", "Every referral counts.", "Making moves. 💪", "The grind never stops."],
  rank8_10: ["Happy to be here!", "Just getting started.", "Climbing one referral at a time.", "The top 10 is just the beginning."],
};
