  ...
  return (
    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: AD.bgPage, fontFamily: AD.fontSans, color: AD.textPrimary }}>
      ...
      <div style={{ marginLeft: 230, flex: 1, position: 'relative', minHeight: '100vh', maxWidth: 'calc(100vw - 230px)' }}>
        ...
        {/* ── Page content ── */}
        {settingsActive
          ? <AdminSettings teamNavRequest={settingsTeamNavRequest} notifNavRequest={settingsNotifNavRequest} onNotifNavConsumed={onSettingsNotifNavConsumed} initialTeamOpenFlagCount={settingsTeamOpenFlagCount} />
