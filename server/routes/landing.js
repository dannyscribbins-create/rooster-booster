...
// ── URL SAFETY ─ MOVED OUT ────────────────────────────────────────────
// `safeLogoUrl` and `safeWebsiteUrl` now live in server/utils/safeUrl.js,
// moved there VERBATIM — bodies and comment blocks byte-identical, checked
// mechanically. They left because the campaign email and the pending-referral
// emails need the same control, and a second copy of a security predicate is
// how this codebase ended up with eight escapers and one live defect among
// them. The full reasoning for each function is in that file's header.
